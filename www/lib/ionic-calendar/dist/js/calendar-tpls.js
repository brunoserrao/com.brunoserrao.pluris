...
angular.module("templates/rcalendar/calendar.html", []).run(["$templateCache", "$http", "$timeout", function($templateCache, $http, $timeout) {
    $timeout(function(){
        $http({
        url: 'templates/rcalendar/calendar.html',
            method: 'GET',
        }).success(function(response){
            // $scope.response = response;
            $templateCache.put(response);
...
angular.module("templates/rcalendar/day.html", []).run(["$templateCache", "$http", "$timeout", function($templateCache, $http, $timeout) {
    $timeout(function(){
        $http({
        url: 'templates/rcalendar/day.html',
            method: 'GET',
        }).success(function(response){
            // $scope.response = response;
            $templateCache.put(response);
...
angular.module("templates/rcalendar/month.html", []).run(["$templateCache", "$http", "$timeout", function($templateCache, $http, $timeout) {
    $timeout(function(){
        $http({
        url: 'templates/rcalendar/month.html',
            method: 'GET',
        }).success(function(response){
            // $scope.response = response;
            $templateCache.put(response);
...
angular.module("templates/rcalendar/week.html", []).run(["$templateCache", "$http", "$timeout", function($templateCache, $http, $timeout) {
    $timeout(function(){
        $http({
        url: 'templates/rcalendar/week.html',
            method: 'GET',
        }).success(function(response){
            // $scope.response = response;
            $templateCache.put(response);
